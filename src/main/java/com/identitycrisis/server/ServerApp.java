 ...
 * Server entry point.
 *
 * Composition Root pattern (manual / "poor-man's" DI)
 * This is the only place in the server that calls {@code new} on
 ...
 * 8. server.set*(router, lobbyManager) (resolve circular refs via setter
 * injection)
