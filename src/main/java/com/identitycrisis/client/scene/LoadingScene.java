...
public class LoadingScene {
    ...
    private void addStonePattern(StackPane root) {
        ...
        // Use solid background color - JavaFX doesn't support multiple gradients in
        // background-image
    ...
    private VBox createTipBox() {
        ...
        tipBox.setStyle("-fx-border-color: " + GOLD_DARK
                + " transparent transparent transparent; -fx-border-width: 1px 0 0 0;");
    ...
    private void addFullscreenButton(StackPane root) {
        ...
        fullscreenBtn.setOnMouseEntered(e -> fullscreenBtn.setStyle(
                "-fx-font-family: 'Press Start 2P', monospace;" +
                        "-fx-font-size: 12px;" +
                        "-fx-text-fill: " + GOLD + ";" +
        ...
        fullscreenBtn.setOnMouseExited(e -> fullscreenBtn.setStyle(
                "-fx-font-family: 'Press Start 2P', monospace;" +
                        "-fx-font-size: 12px;" +
                        "-fx-text-fill: " + GOLD + ";" +
                        "-fx-background-color: " + STONE_PANEL + ";" +
    ...
    /**
     * Called when entering this scene. Starts the animated loading bar
     * and tip rotation. Transitions to LobbyScene when the bar completes.
     */
    public void onEnter() {
        progress = 0;
        statusIndex = 0;
    ...
    /** Stops all animations. Call before leaving this scene. */
    public void onExit() {
